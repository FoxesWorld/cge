...
public class Player extends Node implements PlayerContext {
    ...
    public Player(PlayerModule playerModule, Vector3f spawnPos) {
        ...
        this.bullet = engine.getModuleManager()
                ...
                .getBulletAppState();
        CapsuleCollisionShape shape = new CapsuleCollisionShape(playerModule.getConfig().getPhysics().getRadius(), playerModule.getConfig().getPhysics().getHeight() - 2 * playerModule.getConfig().getPhysics().getRadius(), 1);
        ...
        synchronize(true);
        loadPlayerModel("meshes/YBot.j3o");
    }
